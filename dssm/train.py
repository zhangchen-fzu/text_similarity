...
from textsimilarity.dssm import models
import codecs
...
if __name__ == '__main__':
    ...
    ## --------------------#加载模型
    if 'mlp' == config1['feature_tool']:
        model = models.build_mlp_model(config1)
    elif 'lstm' == config1['feature_tool']:
        model = models.build_lstm_model(config1)
    else:
